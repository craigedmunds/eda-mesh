...
class PostDeploymentE2E:
    ...
    def setup_acceptance_tests(self) -> bool:
        ...
        try:
            ...
            central_tests_source = Path('/workspace/backstage/app/tests/acceptance')
            ...
            if local_acceptance_tests and Path(local_acceptance_tests).exists():
                ...
                plugins_base = Path('/workspace/backstage/app/plugins')
            ...
            # Recreate the original directory structure: backstage/app/
            apps_dir = work_dir / 'backstage' / 'app'
